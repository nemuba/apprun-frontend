          ...
          <Col sm={12} lg={4} md={4}>
            <Card className="mt-3">
              ...
              <Card.Body>
                ...
                <FormGroup>
                  <FormLabel>
                    pontos ganhos: {registration?.position?.score}
                  </FormLabel>
                </FormGroup>
              </Card.Body>
              <Card.Footer>
              ...
              <Col sm={12} lg={12} md={12}>
                <Card className="mt-3">
                  ...
                  <Card.Body>
                    <FormGroup>
                      <FormLabel>
                        Local da corrida: {registration?.race?.local}
                      </FormLabel>
                    </FormGroup>
                    <FormGroup>
                      <FormLabel>
                        Data da corrida: {registration?.race?.date_race}
                      </FormLabel>
                    </FormGroup>
                  </Card.Body>
                  <Card.Footer>
              ...
              <Col sm={12} lg={12} md={12}>
                <Card className="mt-3">
                  ...
                  <Card.Body>
                    <FormGroup>
                      <FormLabel>
                        Modalidade: {registration?.modality?.genre}
                      </FormLabel>
                    </FormGroup>
                    <FormGroup>
                      <FormLabel>
                        Numero de Remo:{" "}
                        {`${registration?.modality?.oar} remo(s)`}
                      </FormLabel>
                    </FormGroup>
                  </Card.Body>
                  <Card.Footer>
              ...
              <Col sm={12} lg={12} md={12}>
                <Card className="mt-3">
                  ...
                  <Card.Body>
                    ...
                    <FormGroup>
                      <FormLabel>
                        Score: {registration?.player?.score} ponto(s)
                      </FormLabel>
                    </FormGroup>
                  </Card.Body>
                  <Card.Footer>
